...
ActiveRecord::Schema[7.0].define(version: 20_230_615_062_353) do
  ...
  create_table 'car_offers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['car_id'], name: 'index_car_offers_on_car_id'
    t.index ['offer_id'], name: 'index_car_offers_on_offer_id'
  end
  ...
  create_table 'cars', force: :cascade do |t|
    ...
    t.text 'image_url'
    t.index ['agent_id'], name: 'index_cars_on_agent_id'
    t.index ['property_id'], name: 'index_cars_on_property_id'
    t.index ['property_manager_id'], name: 'index_cars_on_property_manager_id'
  end
  ...
  create_table 'home_offers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['home_id'], name: 'index_home_offers_on_home_id'
    t.index ['offer_id'], name: 'index_home_offers_on_offer_id'
  end
  ...
  create_table 'land_offers', force: :cascade do |t|
    t.bigint 'land_id', null: false
    t.bigint 'offer_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['land_id'], name: 'index_land_offers_on_land_id'
    t.index ['offer_id'], name: 'index_land_offers_on_offer_id'
  end
  ...
  create_table 'lands', force: :cascade do |t|
    ...
    t.bigint 'property_manager_id', null: false
    t.text 'image_url'
    t.index ['agent_id'], name: 'index_lands_on_agent_id'
    t.index ['property_id'], name: 'index_lands_on_property_id'
    t.index ['property_manager_id'], name: 'index_lands_on_property_manager_id'
  end
  ...
  create_table 'user_car_views', force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.bigint 'car_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['car_id'], name: 'index_user_car_views_on_car_id'
    t.index ['user_id'], name: 'index_user_car_views_on_user_id'
  end
  ...
  create_table 'user_home_views', force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.bigint 'home_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['home_id'], name: 'index_user_home_views_on_home_id'
    t.index ['user_id'], name: 'index_user_home_views_on_user_id'
  end

  create_table 'user_land_views', force: :cascade do |t|
    t.bigint 'user_id', null: false
    t.bigint 'land_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['land_id'], name: 'index_user_land_views_on_land_id'
    t.index ['user_id'], name: 'index_user_land_views_on_user_id'
  end
  ...
  add_foreign_key 'car_offers', 'cars'
  add_foreign_key 'car_offers', 'offers'
  add_foreign_key 'cars', 'agents'
  add_foreign_key 'cars', 'properties'
  add_foreign_key 'cars', 'property_managers'
  add_foreign_key 'deal_infos', 'properties'
  add_foreign_key 'deals', 'agents'
  add_foreign_key 'deals', 'deal_infos'
  add_foreign_key 'deals', 'users'
  add_foreign_key 'home_offers', 'homes'
  add_foreign_key 'home_offers', 'offers'
  ...
  add_foreign_key 'land_offers', 'lands'
  add_foreign_key 'land_offers', 'offers'
  add_foreign_key 'lands', 'agents'
  add_foreign_key 'lands', 'properties'
  add_foreign_key 'lands', 'property_managers'
  ...
  add_foreign_key 'user_car_views', 'cars'
  add_foreign_key 'user_car_views', 'users'
  ...
  add_foreign_key 'user_home_views', 'homes'
  add_foreign_key 'user_home_views', 'users'
  add_foreign_key 'user_land_views', 'lands'
  add_foreign_key 'user_land_views', 'users'
